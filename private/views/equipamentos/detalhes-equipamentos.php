                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-garantia">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <p class="form-control-plaintext">
                                        <a href="../../../docs/garantia_eq001.pdf" target="_blank" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="tab-pane fade" id="tab-contrato">
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <label class="form-label fw-bold">Código</label>
                                    <p class="form-control-plaintext">CON001</p>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <label class="form-label fw-bold">Ficheiro</label>
                                    <p class="form-control-plaintext">
                                        <a href="../../../docs/contrato_eq001.pdf" target="_blank" class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-file-pdf me-1 text-danger"></i>Ver documento
                                        </a>
                                    </p>
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <p class="form-control-plaintext">Contrato de manutenção preventiva associado ao equipamento.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted ms-2">15/03/2022</small>
                                    </div>
                                    <a href="../../../docs/manual_mp5.pdf" target="_blank" class="btn btn-sm btn-outline-primary">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <small class="text-muted ms-2">10/01/2026</small>
                                    </div>
                                    <a href="../../../docs/certificado.pdf" target="_blank" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-file-pdf me-1"></i>Ver
                                    </a>
                                </li>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div>
                                        <i class="fas fa-file-pdf text-danger me-2"></i>
                                        <strong>Contrato de manutenção</strong>
                                        <small class="text-muted ms-2">15/03/2022</small>
                                    </div>
                                    <a href="../../../docs/contrato.pdf" target="_blank" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-file-pdf me-1"></i>Ver
                                    </a>
                                </li>
