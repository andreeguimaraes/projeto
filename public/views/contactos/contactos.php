...
// Morada completa para apresentar
...
<head>
    ...
    <title>Contactos - <?= htmlspecialchars($conteudos['titulo_principal']) ?></title>
        ...
        <div class="contacto-container">
            ...
            <div class="contacto-info">
                ...
                <div class="info-item">
                    ...
                    <div>
                        <h4>Telefone</h4>
                        <p><?= htmlspecialchars($conteudos['telefone']) ?></p>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div>
                        <h4>Email</h4>
                        <p><?= htmlspecialchars($conteudos['email']) ?></p>
                    </div>
                </div>
